/*   STEP 1   */
export const leagueID = "653857136408879104"; // your league ID
export const leagueName = "DieNa$ty"; // your league name
...
export const managers = [
    {
      ...
      "rival": {
        name: "tigerstyle", // Can be anything (usually your rival's name)
      ...
      "philosophy": "Trade a paperclip for a house (Then watch the house burn down because fuck me)",
    ...
    },
    {
      ...
      "favoritePlayer": 7610, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
      "valuePosition": "TE", // (optional) Favorite position (QB, WR, RB, TE, etc.)
      "rookieOrVets": "Rookies", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
      "philosophy": "Whatever reddit says, do the opposite",
      "tradingScale": 7, // 1 - 10
      "preferredContact": "Sleeper", // 'Text', 'WhatsApp', 'Sleeper', 'Email', 'Phone', 'Discord', and 'Carrier Pigeon' are currently supplied in the template
    },
    {
    ...
    },
    {
      ...
      "philosophy": "If they’re not injured yet just wait another play",
      "tradingScale": 7, // 1 - 10
      "preferredContact": "Sleeper", // 'Text', 'WhatsApp', 'Sleeper', 'Email', 'Phone', 'Discord', and 'Carrier Pigeon' are currently supplied in the template
    },
    {
      ...
      "rival": {
        name: "Zaino", // Can be anything (usually your rival's name)
